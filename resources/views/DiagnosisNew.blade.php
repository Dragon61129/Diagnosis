...
@section('content')
    ...
    <div class="main-div">
        ...
        <!-- Create a form  -->
        {{ html()->form('POST', route('newData.post'))->open() }}
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="field-control">
                        <input type="text" name="qualitative_index" placeholder="定性指標No." required />
                ...
                <div class="col">
                    ...
                    <!-- Create a field-control div for input field and validation message -->
                    <div class="field-control">
                        <input type="text" name="big_category" placeholder="大分類" />
                        <!-- Create a span tag with validation message. Initially it is display: none -->
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <!-- Create a field-control div for input field and validation message -->
                    <div class="field-control">
                        <input type="text" name="mid_category" placeholder="中分類" />
                        <!-- Create a span tag with validation message. Initially it is display: none -->
                ...
                <div class="col">
                    ...
                    <!-- Create a field-control div for input field and validation message -->
                    <div class="field-control">
                        <input type="text" name="small_category" placeholder="小分類" />
                        <!-- Create a span tag with validation message. Initially it is display: none -->
            ...
            <div>
                <div class="row">
                    <div class="col">
                        ...
                        <div class="field-control">
                            <input type="text" name="promotion_title" placeholder="" />
                            <!-- Create a span tag with validation message. Initially it is display: none -->
                    ...
                    <div class="col">
                        <textarea style="width:100%; margin: 8px; height: 150px; resize: none;" type="text" name="promotion" placeholder=""></textarea>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="radio" name="qual_quan" value="定性" checked />
                    <span></span>
                    </label>
                    <label class="radio-control">定量
                    <input type="radio" name="qual_quan" value="定量" />
                    <span></span>
                    </label>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <!-- Create a field-control div for input field and validation message -->
                    <div class="field-control">
                        <input type="text" name="current" placeholder="現在" required />
                        <!-- Create a span tag with validation message. Initially it is display: none -->
                ...
                <div class="col">
                    ...
                    <!-- Create a field-control div for input field and validation message -->
                    <div class="field-control">
                        <input type="text" name="future" placeholder="目標(例えば3年後)" required />
                        <!-- Create a span tag with validation message. Initially it is display: none -->
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <!-- Create a field-control div for input field and validation message -->
                    <div class="field-control">
                        <input type="text" name="action" placeholder="アクション欄(任意)" required />
                        <!-- Create a span tag with validation message. Initially it is display: none -->
